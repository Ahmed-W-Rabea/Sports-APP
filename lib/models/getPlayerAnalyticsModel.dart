...
class Result {
  ...
  String? playerType;
  int? playerAge;
  Null? playerMatchPlayed;
  int? playerGoals;
  int? playerYellowCards;
  int? playerRedCards;
  Null? playerMinutes;
  String? playerInjured;
  Null? playerSubstituteOut;
  Null? playerSubstitutesOnBench;
  int? playerAssists;
  String? playerIsCaptain;
  Null? playerShotsTotal;
  Null? playerGoalsConceded;
  Null? playerFoulsCommited;
  Null? playerTackles;
  Null? playerBlocks;
  Null? playerCrossesTotal;
  Null? playerInterceptions;
  Null? playerClearances;
  Null? playerDispossesed;
  Null? playerSaves;
  Null? playerInsideBoxSaves;
  Null? playerDuelsTotal;
  Null? playerDuelsWon;
  Null? playerDribbleAttempts;
  Null? playerDribbleSucc;
  Null? playerPenComm;
  Null? playerPenWon;
  Null? playerPenScored;
  Null? playerPenMissed;
  Null? playerPasses;
  Null? playerPassesAccuracy;
  Null? playerKeyPasses;
  Null? playerWoordworks;
  Null? playerRating;
  String? teamName;
  int? teamKey;
  Null? playerImage;
